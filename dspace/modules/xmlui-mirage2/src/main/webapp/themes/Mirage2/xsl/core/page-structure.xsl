...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="buildHead">
        <head>
            ...
            <meta name="google-site-verification" content="FlNSo61pJaSdVKJe79bR5yeKgsoUp4P-Z0ME_Wn9J0Q" />
    ...
    <xsl:template name="buildTrail">
        <div class="trail-wrapper hidden-print container">
            <div>
                <div class="row">
                    <!--TODO-->
                    ...
                    <div class="col-xs-12 col-sm-12 hidden-print footer-container">
                        <div class="pull-left footer-content">
                            <a title="WPRO" target="_blank" href="http://wpro.who.int/">
                                <xsl:choose>
                                    <xsl:when test="$active-locale='fr'">
                                        <img alt="WPRO" src="/static/images/wpro_footer_emblem_fr.png"/>
                                    </xsl:when>
                                    <xsl:when test="$active-locale='zh'">
                                        <img alt="WPRO" src="/static/images/wpro_footer_emblem_zh.png"/>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <img alt="WPRO" src="/static/images/wpro_footer_emblem_en.png"/>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </a>
                            <br/><br/>
                        ...
                        <div class="hidden-print footer-content">
                            <a>
                                <xsl:attribute name="href">
                                    <xsl:text>mailto:wproiris@who.int</xsl:text>
                                </xsl:attribute>
                            ...
                            <a>
                                <xsl:attribute name="href">
                                    <xsl:text>http://www.wpro.who.int/publications/library_services/en</xsl:text>
                                </xsl:attribute>
                                <xsl:attribute name="target">
                                    <xsl:text>_blank</xsl:text>
                                </xsl:attribute>
                                <i18n:text>wpro.library.information</i18n:text>
                            </a>
                        </div>
                    </div>
                </div>
